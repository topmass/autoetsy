...
def process_file():
    ...
    if html_files:
        ...
        print(f"Script execution for {file_name_without_ext} completed. Outputs saved in pull_image_described.md and image_gen_prompt.md.")
...
if __name__ == "__main__":
    ...
    print("createimage.py execution completed.")
