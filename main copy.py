...
if __name__ == "__main__":
    ...
    print(f"Image renamed to {base_name}.jpg successfully.")
...
# make new folder for to export images and mockups
def create_export_folder(base_name):
    export_path = f"/export/{base_name}"
    try:
        os.makedirs(export_path, exist_ok=True)
        print(f"Folder created at {export_path}.")
    except Exception as e:
        print(f"Failed to create folder: {e}")

create_export_folder(base_name)
